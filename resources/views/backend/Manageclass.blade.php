                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="text-align: center;font-size: 20px; color:rgb(var(--bs-secondary-bg-rgb));">
                            <a href="{{ route ('editclass',$class->id) }}"><i  class="fa-solid fa-pen-to-square me-3" style="color:rgb(34 60 86);"></i></a>
                            <a href="{{ route ('Deleteclass',$class->id) }}"  id="delete" > <i class="fa-solid fa-trash" style="color:rgb(34 60 86);"></i></a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
